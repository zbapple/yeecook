...
module.exports = {
    ...
    IndexUrlTopic: API_BASE_URL + 'index/topic', //首页数据接口
    IndexUrlBrand: API_BASE_URL + 'index/brand', //首页数据接口IndexUrlChannel
    IndexUrlCategory: API_BASE_URL + 'index/category', //首页数据接口IndexUrlChannel
    IndexUrlBanner: API_BASE_URL + 'index/banner', //首页数据接口IndexUrlChannel
    IndexUrlChannel: API_BASE_URL + 'index/channel', //首页数据接口IndexUrlChannel
